...
class Settings:
    def __init__(self):
        ...
        self.network_interface = os.getenv('NETWORK INTERFACE', 'any') #Interface 'any' captura todas as interfaces de rede
        ...
        #self.mysql_db_url = os.getenv('MYSQL_DB_URL', 'mysql://user:password@localhost/netwatch_xdr')
        ...
        self.environment = os.getenv('ENVIRONMENT', 'development or testing or production')#Alternar entre desenvolvimento, testes e produção
